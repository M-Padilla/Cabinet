...
file= "C:/Users/user/Documents/Proyectos/Cabinet 1/SOAT Sura 2.pdf"
...
try:
    ...
    images_from_path = convert_from_path(file,
                                     fmt="jpeg",
                                     dpi=400,
                                     single_file=True)
    for image in images_from_path:
        ...
        try:
            ...
            if insurer_name == "SURA":
                #Modify coordinates of the total_premium field if SOAT is issued by Sura.
            ...
            '''
            key='runt_fee'
            cv.imwrite('BSTRALDO.jpeg',open_cv_image[field_boxes[28][1] : field_boxes[28][3],
                                                     field_boxes[28][0] : field_boxes[28][2]])
            '''
