        ...
        if filetype.guess(pdf_doc).extension != 'pdf':
            ...
            while True:
                try: 
                    ...
                    password=input('Please provide a valid password: ') #HOW TO IMPLEMENT A SECURE PASSWORD INPUT?
...
def img_cropper(image_np_array, insurer):
    ...
    '''  
    cropbox= (200, -1780, 200, -200) #Cropbox's original boundaries (X0,Y0,XF,YF)
    ...
    cropbox= (cropbox[0]+offset[1], cropbox[1]+offset[1], #Adjust cropbox boundaries
...
for field in field_boxes.keys():   
    ...
    output[field]=str(pytesseract.image_to_string(image[field_coords[1] : field_coords[3],
